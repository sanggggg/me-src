...
<br />
![breaking_paragraphs_into_lines](android-text/breaking_paragraphs_into_lines.png)
...
![textview_attributes](android-text/textview_attributes.png)
...
![code_stack_for_text](android-text/code_stack_for_text.png)
...
![icu_locale_word_break](android-text/icu_locale_word_break.png)
*Locale 별 중단점을 잡는 방법*
...
![word_break_stratergies](android-text/word_break_stratergies.png)
...
![balanced_vs_high_quality](android-text/balanced_vs_high_quality.png)
