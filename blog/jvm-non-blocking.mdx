...
> non-blocking api, kernel-jvm buffer mapping 등의 최적화를 제공하는 패키지이며, File I/O 도 저렇게 AsynchronousFileChannel 이 아닌 synchronous I/O 를 위한 api (FileChannel.java) 도 존재한다!
