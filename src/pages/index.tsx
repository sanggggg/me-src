  ...
  return (
    <Layout pageTitle="김상민 (@sanggggg)">
      ...
      <p>
        ...
        에 대해 흥미를 가지고 있습니다. AI, IT 기술을 통해 오프라인의 문제를
        해결하는 것에 관심이 많습니다. 또한 웹/모바일 앱 프로덕트 개발과 그
      ...
      <p>
        ...
        에서 라이드 헤일링 서비스 타다의 모바일 앱(android, iOS), 웹 프론트, 웹
        백엔드, DevOps 포지션으로 3년 간 재직하였습니다.
        <br />
        <blockquote>
          <i>
